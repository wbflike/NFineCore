...
namespace NFineCore.Support
{
    public class WaterMark
    {
        ...
        public static byte[] AddImageSignPic(byte[] byteData, string fileExt, string watermarkFilename, int watermarkStatus, int quality, int watermarkTransparency)
        {
            ...
            colorMap.OldColor = System.DrawingCore.Color.FromArgb(255, 0, 255, 0);
            colorMap.NewColor = System.DrawingCore.Color.FromArgb(0, 0, 0, 0);
            ...
            g.DrawImage(watermark, new System.DrawingCore.Rectangle(xpos, ypos, watermark.Width, watermark.Height), 0, 0, watermark.Width, watermark.Height, GraphicsUnit.Pixel, imageAttributes);
        ...
        public static byte[] AddImageSignText(byte[] byteData, string fileExt, string watermarkText, int watermarkStatus, int quality, string fontname, int fontsize)
        {
            ...
            System.DrawingCore.SizeF crSize;
            ...
            g.DrawString(watermarkText, drawFont, new SolidBrush(System.DrawingCore.Color.White), xpos + 1, ypos + 1);
            g.DrawString(watermarkText, drawFont, new SolidBrush(System.DrawingCore.Color.Black), xpos, ypos);
